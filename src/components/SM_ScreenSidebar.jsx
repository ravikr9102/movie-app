...
function SM_ScreenSidebar({ setToggleMobileAside, setToggleAside }) {
  const [expandedUl, setExpandedUl] = useState(null);
    ...
    if (ul) {
      if (ul === expandedUl) {
        ...
        if (expandedUl) {
          ...
          removeRotateClass(expandedUl.previousElementSibling);
        }
